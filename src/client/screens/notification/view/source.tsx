...
import { NotificationInstanceResponse, RequestInstanceResponse, JobInstanceResponse, ScheduleInstanceResponse, RequestContent, JobContent, ScheduleContent } from '../../../../../types'

export default function Source({ source }: { source: NotificationInstanceResponse | RequestInstanceResponse | JobInstanceResponse | ScheduleInstanceResponse }) {
  return (
